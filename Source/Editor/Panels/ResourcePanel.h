...
namespace NekoEngine
{
    ...
    struct DirectoryInformation
    {
        ...
        SharedPtr<Texture2D> Thumbnail = nullptr;
    ...
    public:
        ...
        static bool MoveOneFile(const std::string& filePath, const std::string& movePath);
        ...
        void DeleteDirectory(SharedPtr<DirectoryInformation>& directory, bool removeFromParent = true);
        void Refresh();
    ...
    private:
        ...
        SharedPtr<Texture2D> m_FolderIcon;
        SharedPtr<Texture2D> m_FileIcon;
