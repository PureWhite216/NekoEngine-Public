...
namespace NekoEngine
{
    ...
    void DebugRenderer::DebugDraw(const BoundingSphere& sphere, const glm::vec4& colour)
    {
        ...
        DebugRenderer::DrawPointNDT(sphere.GetCenter(), sphere.GetRadius(), colour);
    }
    ...
    void DebugRenderer::DebugDraw(Light* light, const glm::quat& rotation, const glm::vec4& colour)
    {
