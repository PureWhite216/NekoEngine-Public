...
namespace NekoEngine
{
    ...
    public:
        ...
        {
            archive(cereal::make_nvp("Scale", m_Scale), cereal::make_nvp("Aspect", m_AspectRatio),
                    cereal::make_nvp("FOV", m_Fov), cereal::make_nvp("Near", m_Near), cereal::make_nvp("Far", m_Far));

            archive(cereal::make_nvp("Aperture", m_Aperture), cereal::make_nvp("ShutterSpeed", m_ShutterSpeed),
                    cereal::make_nvp("Sensitivity", m_Sensitivity));
        }
        ...
        { return std::log2((m_Aperture * m_Aperture) / m_ShutterSpeed * 100.0f / m_Sensitivity); }

        float GetExposure() const
        {
            return 1.0f / (std::pow(2.0f, GetEv100()) * 1.2f);
        }
    };
