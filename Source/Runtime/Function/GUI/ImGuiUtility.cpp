...
namespace NekoEngine
{
    ...
    const char* ImGuiUtility::GenerateID()
    {
    ...
    const char* ImGuiUtility::GenerateLabelID(std::string_view label)
    {
        //TODO: format
...
//        return s_LabelIDBuffer;
    ...
    void ImGuiUtility::PushID()
    {
        ImGui::PushID(s_UIContextID++);
        s_Counter = 0;
    }

    void ImGuiUtility::PopID()
    {
        ImGui::PopID();
        s_UIContextID--;
    }

    bool ImGuiUtility::ToggleButton(const char* label, bool state, ImVec2 size, float alpha, float pressedAlpha, ImGuiButtonFlags buttonFlags)
    {
        if(state)
        {
    ...
    bool ImGuiUtility::Property(const char* name, std::string& value, PropertyFlag flags)
    {
        ...
        {
            if(ImGuiUtility::InputText(value))
            {
                updated = true;
            }
        }
    ...
    void ImGuiUtility::PropertyConst(const char* name, const char* value)
    {
    ...
    bool ImGuiUtility::PropertyMultiline(const char* label, std::string& value)
    {
        bool modified = false;
    ...
    bool ImGuiUtility::Property(const char* name, bool& value, PropertyFlag flags)
    {
    ...
    bool ImGuiUtility::Property(const char* name, int& value, ImGuiUtility::PropertyFlag flags)
    {
    ...
    bool ImGuiUtility::Property(const char* name, uint32_t& value, ImGuiUtility::PropertyFlag flags)
    {
    ...
    bool ImGuiUtility::Property(const char* name, float& value, float min, float max, float delta, ImGuiUtility::PropertyFlag flags)
    {
    ...
    bool ImGuiUtility::Property(const char* name, double& value, double min, double max, PropertyFlag flags)
    {
    ...
    bool ImGuiUtility::Property(const char* name, int& value, int min, int max, PropertyFlag flags)
    {
    ...
    bool ImGuiUtility::Property(const char* name, glm::vec2& value, ImGuiUtility::PropertyFlag flags)
    {
        
        return ImGuiUtility::Property(name, value, -1.0f, 1.0f, flags);
    }

    bool ImGuiUtility::Property(const char* name, glm::vec2& value, float min, float max, ImGuiUtility::PropertyFlag flags)
    {
    ...
    bool ImGuiUtility::Property(const char* name, glm::vec3& value, ImGuiUtility::PropertyFlag flags)
    {
        
        return ImGuiUtility::Property(name, value, -1.0f, 1.0f, flags);
    }

    bool ImGuiUtility::Property(const char* name, glm::vec3& value, float min, float max, ImGuiUtility::PropertyFlag flags)
    {
    ...
    bool ImGuiUtility::Property(const char* name, glm::vec4& value, bool exposeW, ImGuiUtility::PropertyFlag flags)
    {
        
        return Property(name, value, -1.0f, 1.0f, exposeW, flags);
    }

    bool ImGuiUtility::Property(const char* name, glm::vec4& value, float min, float max, bool exposeW, ImGuiUtility::PropertyFlag flags)
    {
    ...
    bool ImGuiUtility::PorpertyTransform(const char* name, glm::vec3& vector, float width)
    {
    ...
    bool ImGuiUtility::Property(const char* name, glm::quat& value, ImGuiUtility::PropertyFlag flags)
    {
    ...
    void ImGuiUtility::Tooltip(const char* text)
    {
    ...
    void ImGuiUtility::Tooltip(Texture2D* texture, const glm::vec2& size)
    {
    ...
    void ImGuiUtility::Tooltip(Texture2D* texture, const glm::vec2& size, const char* text)
    {
    ...
    void ImGuiUtility::Tooltip(TextureDepthArray* texture, uint32_t index, const glm::vec2& size)
    {
        ...
        if(ImGui::IsItemHovered())
        {
            ...
            if(texture && GraphicsContext::GetRenderAPI() == RENDER_API::VULKAN)
                texID = (dynamic_cast<VulkanTextureDepthArray*>(texture))->GetImageView(index);
    ...
    void ImGuiUtility::Image(Texture2D* texture, const glm::vec2& size)
    {
    ...
    void ImGuiUtility::Image(TextureCube* texture, const glm::vec2& size)
    {
    ...
    void ImGuiUtility::Image(TextureDepthArray* texture, uint32_t index, const glm::vec2& size)
    {
        
        bool flipImage = gEngine->GetRenderer()->GetGraphicsContext()->FlipImGUITexture();

        ImTextureID texID = texture ? texture->GetHandle() : nullptr;
#ifdef NekoEngine_RENDER_API_VULKAN
        if(texture && GraphicsContext::GetRenderAPI() == RenderAPI::VULKAN)
            texID = ((VKTextureDepthArray*)texture)->GetImageView(index);
#endif
        ImGui::Image(texID, ImVec2(size.x, size.y), ImVec2(0.0f, flipImage ? 1.0f : 0.0f), ImVec2(1.0f, flipImage ? 0.0f : 1.0f));
    }

    bool ImGuiUtility::BufferingBar(const char* label, float value, const glm::vec2& size_arg, const uint32_t& bg_col, const uint32_t& fg_col)
    {
    ...
    bool ImGuiUtility::Spinner(const char* label, float radius, int thickness, const uint32_t& colour)
    {
    ...
    void ImGuiUtility::DrawRowsBackground(int row_count, float line_height, float x1, float x2, float y_offset, ImU32 col_even, ImU32 col_odd)
    {
    ...
    void ImGuiUtility::TextCentred(const char* text)
    {
    ...
    void ImGuiUtility::SetTheme(Theme theme)
    {
...
#define TEXTCol(v) ImVec4(0.860f, 0.930f, 0.890f, v)
    ...
    glm::vec4 ImGuiUtility::GetSelectedColour()
    {
        return SelectedColour;
    }

    glm::vec4 ImGuiUtility::GetIconColour()
    {
        return IconColour;
    }

    bool ImGuiUtility::PropertyDropdown(const char* label, const char** options, int32_t optionCount, int32_t* selected)
    {
    ...
    void ImGuiUtility::DrawItemActivityOutline(float rounding, bool drawWhenInactive, ImColor colourWhenActive)
    {
        auto* drawList = ImGui::GetWindowDrawList();
    ...
    bool ImGuiUtility::InputText(std::string& currentText)
    {
    ...
    void ImGuiUtility::ClippedText(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align, const ImRect* clip_rect, float wrap_width)
    {
        ...
        ImGuiUtility::ClippedText(window->DrawList, pos_min, pos_max, text, text_display_end, text_size_if_known, align, clip_rect, wrap_width);
        if(g.LogEnabled)
            ImGui::LogRenderedText(&pos_min, text, text_display_end);
    }

    void ImGuiUtility::ClippedText(ImDrawList* draw_list, const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_display_end, const ImVec2* text_size_if_known, const ImVec2& align, const ImRect* clip_rect, float wrap_width)
    {
    ...
    void ImGuiUtility::AlternatingRowsBackground(float lineHeight)
    {
    ...
    ImRect ImGuiUtility::GetItemRect()
    {
        return ImRect(ImGui::GetItemRectMin(), ImGui::GetItemRectMax());
    }

    ImRect ImGuiUtility::RectExpanded(const ImRect& rect, float x, float y)
    {
        ImRect result = rect;
        result.Min.x -= x;
        result.Min.y -= y;
    ...
    ImRect ImGuiUtility::RectOffset(const ImRect& rect, float x, float y)
    {
        ImRect result = rect;
        result.Min.x += x;
        result.Min.y += y;
    ...
    ImRect ImGuiUtility::RectOffset(const ImRect& rect, ImVec2 xy)
    {
        return RectOffset(rect, xy.x, xy.y);
    }

    void ImGuiUtility::DrawBorder(ImVec2 rectMin, ImVec2 rectMax, const ImVec4& borderColour, float thickness, float offsetX, float offsetY)
    {
        auto min = rectMin;
        min.x -= thickness;
        min.y -= thickness;
    ...
    void ImGuiUtility::DrawBorder(const ImVec4& borderColour, float thickness, float offsetX, float offsetY)
    {
        DrawBorder(ImGui::GetItemRectMin(), ImGui::GetItemRectMax(), borderColour, thickness, offsetX, offsetY);
    }

    void ImGuiUtility::DrawBorder(float thickness, float offsetX, float offsetY)
    {
        DrawBorder(ImGui::GetStyleColorVec4(ImGuiCol_Border), thickness, offsetX, offsetY);
    }

    void ImGuiUtility::DrawBorder(ImVec2 rectMin, ImVec2 rectMax, float thickness, float offsetX, float offsetY)
    {
        DrawBorder(rectMin, rectMax, ImGui::GetStyleColorVec4(ImGuiCol_Border), thickness, offsetX, offsetY);
    }

    void ImGuiUtility::DrawBorder(ImRect rect, float thickness, float rounding, float offsetX, float offsetY)
    {
        auto min = rect.Min;
        min.x -= thickness;
        min.y -= thickness;
