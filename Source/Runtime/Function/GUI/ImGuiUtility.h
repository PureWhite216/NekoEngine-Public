...
namespace NekoEngine
{
    ...
    namespace ImGuiUtility
    {
        ...
        void Tooltip(Texture2D* texture, const glm::vec2& size);
        void Tooltip(Texture2D* texture, const glm::vec2& size, const char* text);
        void Tooltip(TextureDepthArray* texture, uint32_t index, const glm::vec2& size);

        void Image(Texture2D* texture, const glm::vec2& size);
        void Image(TextureCube* texture, const glm::vec2& size);
        void Image(TextureDepthArray* texture, uint32_t index, const glm::vec2& size);
